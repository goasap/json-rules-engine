...
Operators.push(new _operator2.default('greaterThanAndLessThan', function (a, b) {
  return a > b[0] && a < b[1];
}));
Operators.push(new _operator2.default('LessThanAndGreaterThan', function (a, b) {
  return a < b[0] && a > b[1];
}));
Operators.push(new _operator2.default('LessThanAndGreaterThanInclusive', function (a, b) {
  return a <= b[0] && a >= b[1];
}));
Operators.push(new _operator2.default('greaterThanAndLessThanInclusive', function (a, b) {
  return a >= b[0] && a <= b[1];
}));
